...
--
-- Host: 127.0.0.1    Database: tienda143
-- ------------------------------------------------------
...
CREATE TABLE `productos` (
  ...
  CONSTRAINT `fk-productos-proveedores` FOREIGN KEY (`nitproveedor`) REFERENCES `proveedores` (`nitproveedor`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-09-25 12:36:05
